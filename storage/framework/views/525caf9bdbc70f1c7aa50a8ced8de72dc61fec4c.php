          ...
          <form action="/complete" enctype="multipart/form-data" method="POST" id="new">
            ...
            <fieldset class="mb-4">
              ...
              <div class="form-group">
                ...
                aria-describedby="Inquiry_content" value="<?php echo e($name); ?>">
                </div>
              </div><br>
              ...
              <div class="form-group">
                ...
                aria-describedby="Inquiry_content" value="<?php echo e($hurigana); ?>">
                </div>
              </div><br>
              ...
              <div class="form-group">
                ...
                aria-describedby="Inquiry_content" value="<?php echo e($Emails); ?>">
                </div>
              </div><br>
              ...
              <div class="form-group">
                ...
                aria-describedby="Inquiry_content" value="<?php echo e($Tel); ?>">
                </div>
              </div><br>
              ...
              <div class="form-group">
                ...
                aria-describedby="Inquiry_content" value="<?php echo e($Inquiry); ?>">
                </div>
              </div><br>
            </fieldset>
...
</html><?php /**PATH /src/resources/views/check.blade.php ENDPATH**/ ?>